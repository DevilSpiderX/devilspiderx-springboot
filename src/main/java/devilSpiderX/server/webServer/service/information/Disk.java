...
public class Disk {
    ...
    public String getTotalStr() {
        ...
        if (total >= GB) {
            return Arith.div(total, GB, 2) + " GB";
        } else if (total >= MB) {
            return Arith.div(total, MB, 2) + " MB";
        } else if (total >= KB) {
            return Arith.div(total, KB, 2) + " KB";
        } else {
    ...
    public String getFreeStr() {
        ...
        int GB = 1024 * 1024 * 1024;
        if (free >= GB) {
            return Arith.div(free, GB, 2) + " GB";
        } else if (free >= MB) {
            return Arith.div(free, MB, 2) + " MB";
        } else if (free >= KB) {
            return Arith.div(free, KB, 2) + " KB";
        } else {
    ...
    public String getUsedStr() {
        ...
        int GB = 1024 * 1024 * 1024;
        if (used >= GB) {
            return Arith.div(used, GB, 2) + " GB";
        } else if (used >= MB) {
            return Arith.div(used, MB, 2) + " MB";
        } else if (used >= KB) {
            return Arith.div(used, KB, 2) + " KB";
        } else {
