...
public class JacksonUtil {
    ...
    public static <T> T parseObject(String jsonString, Class<T> clazz) {
        try {
            ...
            LOGGER.error("Json字符串转为自定义对象失败", e);
    ...
    public static <T> T parseObject(File file, Class<T> clazz) {
        try {
            ...
            LOGGER.error("从文件中读取json字符串转为自定义对象失败", e);
            throw new RuntimeException(e);
        }
    }
    ...
    public static <T> List<T> parseJSONArray(String jsonArray, Class<T> clazz) {
        final var typeRef = TypeFactory.defaultInstance().constructCollectionType(ArrayList.class, clazz);
        try {
            return MAPPER.readValue(jsonArray, typeRef);
        } catch (JsonProcessingException e) {
            LOGGER.error("JSONArray字符串转为List失败", e);
            throw new RuntimeException(e);
        }
    }
    ...
    public static String toJSONString(Object object) {
        try {
            ...
            LOGGER.error("Object转JSONString失败", e);
            throw new RuntimeException(e);
        }
    }
    ...
    public static byte[] toBytes(Object object) {
        try {
            ...
            LOGGER.error("Object转ByteArray失败", e);
            throw new RuntimeException(e);
        }
    }
