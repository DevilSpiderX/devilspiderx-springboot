package devilSpiderX.server.webServer.server.core.service;

import com.mybatisflex.core.query.QueryChain;
import com.mybatisflex.core.row.Db;
import com.mybatisflex.core.update.UpdateChain;
import devilSpiderX.server.webServer.common.core.model.setting.entity.Setting;
import devilSpiderX.server.webServer.common.core.model.setting.mapper.SettingMapper;
...
import static devilSpiderX.server.webServer.common.core.constant.SettingConstant.DEFAULT_SESSION_MAX_AGE;
import static devilSpiderX.server.webServer.common.core.constant.SettingConstant.SESSION_MAX_AGE_KEY;
import static devilSpiderX.server.webServer.common.core.model.setting.entity.table.SettingTableDef.SETTING;
...
public class SettingService {
    ...
    private SettingService self() {
        return context.getBean(SettingService.class);
    }
