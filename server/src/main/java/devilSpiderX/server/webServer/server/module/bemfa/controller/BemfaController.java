package devilSpiderX.server.webServer.server.module.bemfa.controller;

import devilSpiderX.server.webServer.server.module.bemfa.service.BemfaMqttService;
...
public class BemfaController implements ApplicationRunner {
    ...
    private final Thread.Builder taskThreadBuilder = Thread.ofVirtual()
            .name("send-bemfa-mqtt-thread");
